...
package com.bes.test.jacc.contexts.servlet;
...
import com.bes.test.jacc.contexts.bean.BeanMessageInterface;
import com.bes.test.jacc.contexts.bean.BeanRootInterface;
            ...
            if (testcase != null) {
                ...
                if ("InjectLookup".equals(testcase)) {
                    ...
                    if (request.getParameter("web") == null) {
                        ...
                        EJBlookupName = "java:global/jacctest/jaccejb/BeanRoot";
                    } else {
                        // For standalone war:
                    ...
                    if(request.getParameter("exp") != null) {
                        Permission permission = new java.net.URLPermission("http://localhost:1900/console/index.action", "read");
                        try {
                            if (System.getSecurityManager() != null) {
                                AccessController.checkPermission(permission);
                                checkReport.append("servlet - success for exception.txt; ");
                            } else
                                checkReport.append("servlet - bypass for exception.txt; ");
                        } catch (AccessControlException e) {
                            e.printStackTrace(out);
                            checkReport.append("servlet - failed for exception.txt; ");
                            status = false;
                        }
                    }
