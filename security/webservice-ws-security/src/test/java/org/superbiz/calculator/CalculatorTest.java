...
public class CalculatorTest extends TestCase {
    ...
    public void testCalculatorViaWsInterfaceWithEncryptSign() throws Exception {
        final Service calcService = Service.create(new URL("http://localhost:8080/webservice-ws-security/webservices/CalculatorImplEncryptSign?wsdl"),
    ...
    public void testCalculatorViaWsInterfaceWithEncryptSignSSL() throws Exception {
        ...
        ((BindingProvider) calc).getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, "https://localhost:" + port + "/webservice-ws-security/webservices/CalculatorImplEncryptSign");
